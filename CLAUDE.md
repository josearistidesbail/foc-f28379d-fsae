...
volatile uint16_t  g_resolver_filt_en;     // 0=bypass (default SENSOR_RES_FILT_DEFAULT_EN=0), 1=filter; "res_filt_en" param
volatile float32_t g_resolver_filt_hz;     // -3 dB cutoff [Hz]; "res_filt_hz" param recomputes alpha (default 1000)
